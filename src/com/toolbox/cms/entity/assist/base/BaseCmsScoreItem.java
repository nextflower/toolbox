...
public abstract class BaseCmsScoreItem  implements Serializable {
	...
	public BaseCmsScoreItem (
		...
		com.toolbox.cms.entity.assist.CmsScoreGroup group,
	...
	// many to one
	private com.toolbox.cms.entity.assist.CmsScoreGroup group;

	// collections
	private java.util.Set<com.toolbox.cms.entity.assist.CmsScoreRecord> records;
	 ...
	 */
	public com.toolbox.cms.entity.assist.CmsScoreGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (com.toolbox.cms.entity.assist.CmsScoreGroup group) {
		this.group = group;
	}
	 ...
	 */
	public java.util.Set<com.toolbox.cms.entity.assist.CmsScoreRecord> getRecords () {
		return records;
	}
	 ...
	 */
	public void setRecords (java.util.Set<com.toolbox.cms.entity.assist.CmsScoreRecord> records) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.toolbox.cms.entity.assist.CmsScoreItem)) return false;
		else {
			com.toolbox.cms.entity.assist.CmsScoreItem cmsScoreItem = (com.toolbox.cms.entity.assist.CmsScoreItem) obj;
