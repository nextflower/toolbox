...
public abstract class BaseCmsVoteSubTopic  implements Serializable {
	...
	public BaseCmsVoteSubTopic (
		...
		com.toolbox.cms.entity.assist.CmsVoteTopic voteTopic,
	...
	// many to one
	private com.toolbox.cms.entity.assist.CmsVoteTopic voteTopic;

	// collections
	private java.util.Set<com.toolbox.cms.entity.assist.CmsVoteItem> voteItems;
	private java.util.Set<com.toolbox.cms.entity.assist.CmsVoteReply> voteReplys;
	 ...
	 */
	public com.toolbox.cms.entity.assist.CmsVoteTopic getVoteTopic () {
		return voteTopic;
	}
	 ...
	 */
	public void setVoteTopic (com.toolbox.cms.entity.assist.CmsVoteTopic voteTopic) {
	 ...
	 */
	public java.util.Set<com.toolbox.cms.entity.assist.CmsVoteItem> getVoteItems () {
		return voteItems;
	}
	 ...
	 */
	public void setVoteItems (java.util.Set<com.toolbox.cms.entity.assist.CmsVoteItem> voteItems) {
	 ...
	 */
	public java.util.Set<com.toolbox.cms.entity.assist.CmsVoteReply> getVoteReplys () {
		return voteReplys;
	}
	 ...
	 */
	public void setVoteReplys (java.util.Set<com.toolbox.cms.entity.assist.CmsVoteReply> voteReplys) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.toolbox.cms.entity.assist.CmsVoteSubTopic)) return false;
		else {
			com.toolbox.cms.entity.assist.CmsVoteSubTopic cmsVoteSubTopic = (com.toolbox.cms.entity.assist.CmsVoteSubTopic) obj;
