...
public abstract class BaseCmsMessage  implements Serializable {
	...
	// many to one
	private com.toolbox.core.entity.CmsUser msgReceiverUser;
	private com.toolbox.core.entity.CmsUser msgSendUser;
	private com.toolbox.core.entity.CmsSite site;
	
	// collections
	private java.util.Set<com.toolbox.cms.entity.assist.CmsReceiverMessage> receiverMsgs;
	 ...
	 */
	public com.toolbox.core.entity.CmsUser getMsgReceiverUser () {
	 ...
	 */
	public void setMsgReceiverUser (com.toolbox.core.entity.CmsUser msgReceiverUser) {
	 ...
	 */
	public com.toolbox.core.entity.CmsUser getMsgSendUser () {
		return msgSendUser;
	}
	 ...
	 */
	public void setMsgSendUser (com.toolbox.core.entity.CmsUser msgSendUser) {
	...
	public java.util.Set<com.toolbox.cms.entity.assist.CmsReceiverMessage> getReceiverMsgs() {
		return receiverMsgs;
	}

	public void setReceiverMsgs(
			java.util.Set<com.toolbox.cms.entity.assist.CmsReceiverMessage> receiverMsgs) {
		this.receiverMsgs = receiverMsgs;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.toolbox.cms.entity.assist.CmsMessage)) return false;
		else {
			com.toolbox.cms.entity.assist.CmsMessage cmsMessage = (com.toolbox.cms.entity.assist.CmsMessage) obj;
