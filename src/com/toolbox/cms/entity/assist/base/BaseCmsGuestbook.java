package com.toolbox.cms.entity.assist.base;
...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.toolbox.cms.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private com.toolbox.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.toolbox.core.entity.CmsUser member;
	private com.toolbox.core.entity.CmsUser admin;
	private com.toolbox.core.entity.CmsSite site;
	private com.toolbox.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.toolbox.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.toolbox.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.toolbox.core.entity.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.toolbox.core.entity.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.toolbox.core.entity.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.toolbox.core.entity.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.toolbox.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.toolbox.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.toolbox.cms.entity.assist.CmsGuestbook)) return false;
		else {
			com.toolbox.cms.entity.assist.CmsGuestbook cmsGuestbook = (com.toolbox.cms.entity.assist.CmsGuestbook) obj;
