...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		com.toolbox.core.entity.CmsConfig config,
	...
	// many to one
	private com.toolbox.core.entity.Ftp uploadFtp;
	private com.toolbox.core.entity.CmsConfig config;
	// one to one
	private com.toolbox.core.entity.CmsSiteCompany siteCompany;
	 ...
	 */
	public com.toolbox.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.toolbox.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.toolbox.core.entity.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.toolbox.core.entity.CmsConfig config) {
		this.config = config;
	}
	
	public com.toolbox.core.entity.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.toolbox.core.entity.CmsSiteCompany siteCompany) {
	...
	public void setUserSites(
			java.util.Set<com.toolbox.core.entity.CmsUserSite> userSites) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.toolbox.core.entity.CmsSite)) return false;
		else {
			com.toolbox.core.entity.CmsSite cmsSite = (com.toolbox.core.entity.CmsSite) obj;
